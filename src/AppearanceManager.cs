...
namespace MyChildCore
{
    ...
    public static class AppearanceManager
    {
        ...
        /// </summary>
        public static void ApplyBabyAppearance(Child child, ChildParts parts, DropdownConfig config)
        {
            if (child == null || parts == null || config == null || !config.EnableMod)
                return;
        ...
        public static void ApplyForGMCMChange(string spouse, bool isMale, DropdownConfig config)
        {
            ...
            foreach (var child in ChildManager.GetAllChildren())
            {
                ...
                if (child.Age >= 1)
                    ...
                    ApplyBabyAppearance(child, parts, config);
            }
        }
    }
}