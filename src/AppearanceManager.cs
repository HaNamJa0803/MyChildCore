...
namespace MyChildCore
{
    ...
    public static class AppearanceManager
    {
        ...
        public static void ApplyToddlerAppearance(Child child, ChildParts parts)
        {
            ...
            {
                string pajamaPath = $"assets/Clothes/Sleep/{(isMale ? parts.PajamaTypeOptions : parts.PajamaTypeOptions)}/{(isMale ? parts.PajamaColorOptions : parts.PajamaColorOptions)}.png";
            ...
            if (useFestival && Game1.isFestival())
            {
                ...
                else if (season == "summer")
                {
                    ...
                    string summerBottomPath = isMale
                        ? $"assets/Clothes/Festival/Summer/{parts.FestivalSummerPantsOptions}.png"
                        : $"assets/Clothes/Festival/Summer/{parts.FestivalSummerSkirtOptions}.png";
                ...
                else if (season == "fall")
                {
                    string fallBottomPath = isMale
                        ? $"assets/Clothes/Festival/Fall/{parts.FestivalFallPants}.png"
                        : $"assets/Clothes/Festival/Fall/{parts.FestivalFallSkirts}.png";
                ...
                else if (season == "winter")
                {
                    ...
                    string winterBottomPath = isMale
                        ? $"assets/Clothes/Festival/Winter/{parts.FestivalWinterPantsOptions}.png"
                        : $"assets/Clothes/Festival/Winter/{parts.FestivalWinterSkirtOptions}.png";
            ...
            string bottomPath = isMale
                ? $"assets/Clothes/Bottom/Pants/{parts.BoyPantsColorOptions}.png"
                : $"assets/Clothes/Bottom/Skirt/{parts.GirlSkirtColorOptions}.png";
            string shoesPath = $"assets/Clothes/Shoes/{(isMale ? parts.ShoesColorOptions : parts.GlShoesColorOptions)}.png";
            string neckPath = $"assets/Clothes/NeckCollar/{(isMale ? parts.NeckCollarColorOptions : parts.NeckCollarColorOptions)}.png";
