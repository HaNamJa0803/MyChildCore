...
namespace MyChildCore
{
    ...
    public static class AppearanceManager
    {
        ...
        public static void ApplyToddlerAppearance(Child child, ChildParts parts)
        {
            ...
            {
                string pajamaPath = $"assets/Clothes/Sleep/{(isMale ? parts.BoyPajamaTypeOptions : parts.BoyPajamaTypeOptions)}/{(isMale ? parts.GirlPajamaColorOptions : parts.GirlPajamaColorOptions)}.png";
