...
namespace MyChildCore
{
    ...
    {
        // === Observer/이벤트: 변경시 실시간 알림 (필요 시 구독) ===
        ...
        {
            get => _name;
            set { if (_name != value) { _name = value; Notify(nameof(Name), value); } }
        }
        ...
        {
            get => _parentID;
            set { if (_parentID != value) { _parentID = value; Notify(nameof(ParentID), value); } }
        }
        ...
        {
            get => _gender;
            set { if (_gender != value) { _gender = value; Notify(nameof(Gender), value); } }
        }
        ...
        {
            get => _age;
            set { if (_age != value) { _age = value; Notify(nameof(Age), value); } }
        }
        ...
        private void Notify(string field, object value)
        {
            ...
            catch { /* 실전에서는 CustomLogger.Warn 등으로 예외처리 */ }
        }
        ...
        // === (Optional) ChildParts로 변환 (연동/동기화용) ===
