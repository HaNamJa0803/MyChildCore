...
namespace MyChildCore
{
    ...
    public static class ChildManager
    {
        ...
        /// </summary>
        public static List<Child> GetAllChildren(ModConfig config = null)
        {
            ...
            if (list.Count == 0)
            {
                ...
                DataManager.RestoreLatestBackup(config);
                ...
                try
                {
                    ...
                    if (npcs2 != null)
                    {
                        foreach (var npc2 in npcs2)
                        {
                            if (npc2 is Child child2)
                                list.Add(child2);
                        }
                    }
                }
        ...
        /// </summary>
        public static Child FindChild(string parentName, bool isMale, ModConfig config = null)
        {
            var all = GetAllChildren(config);
