...
using StardewModdingAPI.Imanifest;
...
namespace MyChildCore
{
    ...
    {
        private readonly IGenericModConfigMenuApi gmcm;  // ★★ 이게 빠지면 안돼!
        private readonly StardewModdingAPI.IManifest modManifest;

        public ChildMenuApi(IModHelper helper, StardewModdingAPI.IManifest manifest)
        {
