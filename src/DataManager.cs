    ...
    public static class DataManager
    {
        ...
        private static string SaveDir
        {
            get
            {
                ...
                // Helper.DirectoryPath == 모드 루트 폴더(예: Mods/모드이름)
                // Data폴더는 platform-safe 저장소임
                string dataRoot = Helper.Data.GetSaveFolder();
                // 예: .../Mods/MyChildCore/data/플레이어명_숫자
                return Path.Combine(dataRoot, folder);
            }
        }
