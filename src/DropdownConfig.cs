...
namespace MyChildCore.Utilities
{
    ...
    public class DropdownConfig
    {
        ...
        // 각 스타일별 색상 개수 (예: Frog 8, Sheep 7 ...)
        public static readonly Dictionary<string, int> PajamaColorMax = new Dictionary<string, int>
        {
            { "Frog", 8 },
            { "WelshCorgi", 8 },
            { "Sheep", 7 },
