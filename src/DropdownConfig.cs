public static class DropdownConfig
{
    ...
    // 신발 색상
    public static readonly string[] ShoesOptions = { "Black", "Blue", "Red", "Socks" }; // 4개
    ...
    // 축제 파츠(고정/공용)
    public static readonly string[] FestivalSpringHatOptions = { "FestivalSpringHat" };
    public static readonly string[] FestivalWinterHatOptions = { "FestivalWinterHat" };
    public static readonly string[] FestivalWinterScarfOptions = { "FestivalWinterScarf" };
    public static readonly string[] GirlFestivalSummerSkirtOptions = { "FestivalSummerSkirt1", "FestivalSummerSkirt2" };
    public static readonly string[] GirlFestivalFallSkirtOptions = { "FestivalFallSkirt" };
    ...
    public static readonly string[] BoyFestivalFallPantsOptions = { "FestivalFallPants" };
