...
public static class DropdownConfig
{
    ...
    public static readonly string[] GirlEyes = { "Black", "Blue", "Brown", "Green", "Pink", "Violet" };
    public static readonly string[] GirlSkins = { "Light", "Brown", "Dark" };

    // 남자 유아
    public static readonly string[] BoyHairStyles = { "Short" };
    public static readonly string[] BoyEyes = { "Black", "Blue", "Brown", "Green", "Pink", "Violet" };
    public static readonly string[] BoySkins = { "Light", "Brown", "Dark" };

    // 치마/바지 색상
    public static readonly string[] SkirtColorOptions = { "Black", "Blue", "Brown", "Emerald", "Green", "Pink", "SkyBlue", "Violet", "Yellow" };
    public static readonly string[] PantsColorOptions = { "Black", "Blue", "Brown", "Green", "Orange", "Pink", "SkyBlue", "Violet", "Yellow" };
