...
public static class DropdownConfig
{
    ...
    // 치마/바지 색상
    public static readonly string[] SkirtColorOptions = { "Black", "Blue", "Brown", "Emerald", "Green", "Pink", "SkyBlue", "Violet", "Yellow" }; // 10개
    public static readonly string[] PantsColorOptions = { "Black", "Blue", "Brown", "Green", "Orange", "Pink", "SkyBlue", "Violet", "Yellow" }; // 10개

    // 신발 색상
    public static readonly string[] ShoesColorOptions = { "Black", "Blue", "Red", "Socks" }; // 4개

    // 넥칼라 색상
    public static readonly string[] NeckCollarColorsOtions =
