...
public static class DropdownConfig
{
    ...
    public static readonly string[] GirlEyes = { "Abigail", "Alex", "Black", "Blue", "Brown", "Elliott", "Emerald", "Emily", "Green", "Haley", "Harvey", "Leah", "Maru", "MossGreen", "Orange", "Penny", "Pink","Purple","Red","Sam","Sebastian","Shane","Skyblue","Violet","Yellow","YellowGreen" };
    public static readonly string[] GirlSkins = { "Light", "Brown", "Dark" };

    // 남자 유아
    public static readonly string[] BoyHairStyles = { "Short" };
    public static readonly string[] BoyEyes = { "Abigail", "Alex", "Black", "Blue", "Brown", "Elliott", "Emerald", "Emily", "Green", "Haley", "Harvey", "Leah", "Maru", "MossGreen", "Orange", "Penny", "Pink","Purple","Red","Sam","Sebastian","Shane","Skyblue","Violet","Yellow","YellowGreen" };
    public static readonly string[] BoySkins = { "Light", "Brown", "Dark" };
