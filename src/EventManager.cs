...
namespace MyChildCore.Utilities
{
    public static class MyChildCoreUtilities
    {
        ...
        public static void RegisterAllEvents(IModHelper helper, Action syncCallback)
        {
            ...
            helper.Events.GameLoop.GameWindowResized += OnAnyEvent;
            helper.Events.GameLoop.ReturnedToNewGame += OnAnyEvent;
            ...
            helper.Events.Player.ToolChanged += OnAnyEvent;
            helper.Events.Player.ActiveItemChanged += OnAnyEvent;
            ...
            helper.Events.World.FarmExpansionListChanged += OnAnyEvent;
