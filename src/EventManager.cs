...
namespace MyChildCore
{
    ...
    public static class EventManager
    {
        ...
        // [중복 제거!] 실제 동작은 "여러 줄짜리" 구현만 남기고, 람다 버전 삭제!
        ...
        public static void OnRenderedActiveMenu(object s, RenderedActiveMenuEventArgs e) { /* 필요시 구현 */ }
        public static void OnAssetRequested(object s, AssetRequestedEventArgs e) { /* 필요시 구현 */ }
        public static void OnReturnedToTitle(object s, ReturnedToTitleEventArgs e) { /* 필요시 구현 */ }
        public static void OnUpdateTicked(object s, UpdateTickedEventArgs e) { /* 필요시 구현 */ }
        public static void OnButtonReleased(object s, ButtonReleasedEventArgs e) { /* 필요시 구현 */ }
        public static void OnPeerConnected(object s, PeerConnectedEventArgs e) { /* 필요시 구현 */ }
        public static void OnModMessageReceived(object s, ModMessageReceivedEventArgs e) { /* 필요시 구현 */ }
