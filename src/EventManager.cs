...
namespace MyChildCore
{
    ...
    public class ModEntry : Mod
    {
        ...
        {
            // 주요 이벤트 등록 (유니크 칠드런 방식)
            helper.Events.GameLoop.SaveLoaded += MyChildCore.Utilities.MyChildCoreUtilities.OnSaveLoaded;
            helper.Events.GameLoop.DayStarted += MyChildCore.Utilities.MyChildCoreUtilities.OnDayStarted;
            helper.Events.Player.Warped += MyChildCore.Utilities.MyChildCoreUtilities.OnWarped;
            helper.Events.Display.MenuChanged += MyChildCore.Utilities.MyChildCoreUtilities.OnMenuChanged;
            helper.Events.GameLoop.Saved += MyChildCore.Utilities.MyChildCoreUtilities.OnSaved;
        }
    }
}
...
{
    // ※ GlobalDropdownConfig.Instance 등은 별도 싱글턴으로 준비
