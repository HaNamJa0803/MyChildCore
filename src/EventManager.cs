...
namespace MyChildCore.Utilities
{
    ...
    // ChildData/Config 등은 간단히 별도 정의, 여기선 생략(기본 구조 유지)
    public class ChildData { public string Name; public long ParentID; public int Gender; }
    public class Config
    {
        public int GetShoesIndex(string spouseName, bool isMale) => 1;
        public int GetBottomIndex(string spouseName, bool isMale) => 1;
        public int GetNeckIndex(string spouseName, bool isMale) => 1;
        public string GetHairStyle(string spouseName) => "CherryTwin";
        public string GetPajamaStyle(string spouseName, bool isMale) => "Frog";
        public int GetPajamaColorIndex(string spouseName, bool isMale) => 1;
    }
}