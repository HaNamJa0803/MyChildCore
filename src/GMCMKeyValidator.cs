...
namespace MyChildCore
{
    ...
    public static class GMCMKeyValidator
    {
        ...
        /// </summary>
        public static bool IsValidKey(string gmcmKey, ModConfig config)
        {
            if (string.IsNullOrEmpty(gmcmKey) || config.SpouseConfigs == null)
                return false;
        ...
        {
            if (child == null || config.SpouseConfigs == null)
                return;
        ...
        public static List<string> GetMissingKeys(IEnumerable<Child> children)
        {
            ...
            if (children == null || config.SpouseConfigs == null)
                return missing;
