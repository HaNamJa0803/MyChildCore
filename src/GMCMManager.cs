        ...
        public static void RegisterGMCM(IModHelper helper, Mod mod)
        {
            ...
            foreach (var spouse in DropdownConfig.SpouseNames)
            {
                ...
                gmcm.AddBoolOption(
                    ...
                    setValue: v => { Config.SpouseConfigs[spouse].EnablePajama = v; NotifyConfigChanged(); }
                );
                gmcm.AddBoolOption(
                    mod: mod.ModManifest,
                    name: () => "축제복 활성화",
                    ...
                    setValue: v => { Config.SpouseConfigs[spouse].EnableFestival = v; NotifyConfigChanged(); }
                );

                // ======= 아기(0세) 파츠 =======
                gmcm.AddSectionTitle(mod: mod.ModManifest, text: () => "아기", tooltip: null);

                gmcm.AddTextOption(mod: mod.ModManifest, name: () => "헤어스타일", tooltip: () => "아기의 헤어스타일",
                ...
                gmcm.AddTextOption(mod: mod.ModManifest, name: () => "눈동자 색상", tooltip: () => "아기의 눈동자 색상",
                ...
                gmcm.AddTextOption(mod: mod.ModManifest, name: () => "피부색", tooltip: () => "아기의 피부색",
                ...
                gmcm.AddTextOption(mod: mod.ModManifest, name: () => "의상", tooltip: () => "아기의 옷",
                ...
                gmcm.AddTextOption(mod: mod.ModManifest, name: () => "헤어스타일", tooltip: () => "남자 유아의 헤어스타일",
                ...
                gmcm.AddTextOption(mod: mod.ModManifest, name: () => "눈동자 색상", tooltip: () => "남자 유아의 눈동자 색상",
                ...
                gmcm.AddTextOption(mod: mod.ModManifest, name: () => "피부색", tooltip: () => "남자 유아의 피부색",
                ...
                gmcm.AddTextOption(mod: mod.ModManifest, name: () => "봄 상의", tooltip: () => "남자 유아의 봄 상의",
                ...
                gmcm.AddTextOption(mod: mod.ModManifest, name: () => "여름 상의", tooltip: () => "남자 유아의 여름 상의",
                ...
                gmcm.AddTextOption(mod: mod.ModManifest, name: () => "가을 상의", tooltip: () => "남자 유아의 가을 상의",
                ...
                gmcm.AddTextOption(mod: mod.ModManifest, name: () => "겨울 상의", tooltip: () => "남자 유아의 겨울 상의",
                ...
                gmcm.AddTextOption(mod: mod.ModManifest, name: () => "바지 색상", tooltip: () => "남자 유아의 바지 색상",
                ...
                gmcm.AddTextOption(mod: mod.ModManifest, name: () => "신발 색상", tooltip: () => "남자 유아의 신발 색상",
                ...
                gmcm.AddTextOption(mod: mod.ModManifest, name: () => "넥칼라 색상", tooltip: () => "남자 유아의 넥칼라 색상",
                ...
                gmcm.AddTextOption(mod: mod.ModManifest, name: () => "잠옷 스타일", tooltip: () => "남자 유아의 잠옷 스타일",
                ...
                gmcm.AddTextOption(mod: mod.ModManifest, name: () => "잠옷 색상", tooltip: () => "남자 유아의 잠옷 색상",
                ...
                gmcm.AddTextOption(mod: mod.ModManifest, name: () => "봄 축제복 모자", tooltip: () => "남자 유아의 봄 축제복 모자",
                ...
                gmcm.AddTextOption(mod: mod.ModManifest, name: () => "여름 축제복 모자", tooltip: () => "남자 유아의 여름 축제복 모자",
                ...
                gmcm.AddTextOption(mod: mod.ModManifest, name: () => "여름 축제복", tooltip: () => "남자 유아의 여름 축제복",
                ...
                gmcm.AddTextOption(mod: mod.ModManifest, name: () => "가을 축제복", tooltip: () => "남자 유아의 가을 축제복",
                ...
                gmcm.AddTextOption(mod: mod.ModManifest, name: () => "겨울 축제복 모자", tooltip: () => "남자 유아의 겨울 축제복 모자",
                ...
                gmcm.AddTextOption(mod: mod.ModManifest, name: () => "겨울 축제복", tooltip: () => "남자 유아의 겨울 축제복",
                ...
                gmcm.AddTextOption(mod: mod.ModManifest, name: () => "겨울 목도리", tooltip: () => "남자 유아의 겨울 축제복 목도리",
