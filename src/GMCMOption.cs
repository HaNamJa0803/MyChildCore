...
namespace MyChildCore
{
    ...
    public static class GMCMOptionsMenus
    {
        public static readonly List<GMCMOption> GMCMOptions = new()
        {
            ...
            // 여름 치마
            new GMCMOption {
                NameKey = "option.girl.festival.summer.pants.type",
                TooltipKey = "tooltip.girl.festival.summer.pants.type",
                IsGirl = true,
            ...
            new GMCMOption {
                NameKey = "option.girl.festival.summer.pants.color",
                TooltipKey = "tooltip.girl.festival.summer.pants.color",
                IsGirl = true,
            ...
            // 가을 치마
            new GMCMOption {
                NameKey = "option.girl.festival.fall.pants.type",
                TooltipKey = "tooltip.girl.festival.fall.pants.type",
                IsGirl = true,
            ...
            new GMCMOption {
                NameKey = "option.girl.festival.fall.pants.color",
                TooltipKey = "tooltip.girl.festival.fall.pants.color",
                IsGirl = true,
            ...
            // 겨울 치마
            new GMCMOption {
                NameKey = "option.girl.festival.winter.pants.type",
                TooltipKey = "tooltip.girl.festival.winter.pants.type",
                IsGirl = true,
            ...
            new GMCMOption {
                NameKey = "option.girl.festival.winter.pants.color",
                TooltipKey = "tooltip.girl.festival.winter.pants.color",
                IsGirl = true,
            ...
            new GMCMOption {
                ...
                IsBoy = true,
                GetValue = s => ModEntry.Config.SpouseConfigs[s].BoyFestivalSummerSkirtType,
                SetValue = (s, v) => { ModEntry.Config.SpouseConfigs[s].BoyFestivalSummerSkirtType = v; },
                AllowedValues = s => ModEntry.Config.SpouseConfigs[s].BoyFestivalSummerSkirtTypeOptions.ToArray()
            },
            new GMCMOption {
                NameKey = "option.boy.festival.summer.pants.color",
                TooltipKey = "tooltip.boy.festival.summer.pants.color",
                IsBoy = true,
                GetValue = s => ModEntry.Config.SpouseConfigs[s].BoyFestivalSummerSkirtColor,
                SetValue = (s, v) => { ModEntry.Config.SpouseConfigs[s].BoyFestivalSummerSkirtColor = v; },
                AllowedValues = s => {
                    var dict = ModEntry.Config.SpouseConfigs[s].BoyFestivalSummerSkirtColorOptions;
                    var type = ModEntry.Config.SpouseConfigs[s].BoyFestivalSummerSkirtType;
                    return dict.ContainsKey(type) ? dict[type].ToArray()
                        : (dict.ContainsKey("Default") ? dict["Default"].ToArray() : Array.Empty<string>());
                }
            },
            ...
            new GMCMOption {
                ...
                IsBoy = true,
                GetValue = s => ModEntry.Config.SpouseConfigs[s].BoyFestivalFallSkirtType,
                SetValue = (s, v) => { ModEntry.Config.SpouseConfigs[s].BoyFestivalFallSkirtType = v; },
                AllowedValues = s => ModEntry.Config.SpouseConfigs[s].BoyFestivalFallSkirtTypeOptions.ToArray()
            },
            new GMCMOption {
                NameKey = "option.boy.festival.fall.pants.color",
                TooltipKey = "tooltip.boy.festival.fall.pants.color",
                IsBoy = true,
                GetValue = s => ModEntry.Config.SpouseConfigs[s].BoyFestivalFallSkirtColor,
                SetValue = (s, v) => { ModEntry.Config.SpouseConfigs[s].BoyFestivalFallSkirtColor = v; },
                AllowedValues = s => {
                    var dict = ModEntry.Config.SpouseConfigs[s].BoyFestivalFallSkirtColorOptions;
                    var type = ModEntry.Config.SpouseConfigs[s].BoyFestivalFallSkirtType;
                    return dict.ContainsKey(type) ? dict[type].ToArray()
                        : (dict.ContainsKey("Default") ? dict["Default"].ToArray() : Array.Empty<string>());
                }
            },
            ...
            new GMCMOption {
                ...
                IsBoy = true,
                GetValue = s => ModEntry.Config.SpouseConfigs[s].BoyFestivalWinterSkirtType,
                SetValue = (s, v) => { ModEntry.Config.SpouseConfigs[s].BoyFestivalWinterSkirtType = v; },
                AllowedValues = s => ModEntry.Config.SpouseConfigs[s].BoyFestivalWinterSkirtTypeOptions.ToArray()
            },
            new GMCMOption {
                NameKey = "option.boy.festival.winter.pants.color",
                TooltipKey = "tooltip.boy.festival.winter.pants.color",
                IsBoy = true,
                GetValue = s => ModEntry.Config.SpouseConfigs[s].BoyFestivalWinterSkirtColor,
                SetValue = (s, v) => { ModEntry.Config.SpouseConfigs[s].BoyFestivalWinterSkirtColor = v; },
                AllowedValues = s => {
                    var dict = ModEntry.Config.SpouseConfigs[s].BoyFestivalWinterSkirtColorOptions;
                    var type = ModEntry.Config.SpouseConfigs[s].BoyFestivalWinterSkirtType;
                    return dict.ContainsKey(type) ? dict[type].ToArray()
                        : (dict.ContainsKey("Default") ? dict["Default"].ToArray() : Array.Empty<string>());
                }
            },
