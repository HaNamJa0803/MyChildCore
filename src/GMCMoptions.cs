        ...
        public static readonly List<GMCMOption> GMCMOptions = new()
        {
            ...
            new GMCMOption
            {
             ...
             new GMCMOption
             {
                 ...
                 IsBoy = false,
                 GetValue = s => ModEntry.Config.SpouseConfigs[s].GirlSkirtColorOptions,
                 SetValue = (s, v) => ModEntry.Config.SpouseConfigs[s].GirlSkirtColorOptions = v,
             ...
             new GMCMOption
             {
                 ...
                 AllowedValues = () => DropdownConfig.ShoesColorOptions
             },
             new GMCMOption
             {
                 ...
                 AllowedValues = () => DropdownConfig.NeckCollarColorOptions
             },
             // 잠옷(타입/색상)
             new GMCMOption
             {
             ...
             new GMCMOption
             {
                 ...
                 AllowedValues = () => DropdownConfig.FestivalSummerSkirtOptions
             },
             new GMCMOption
             {
             ...
             new GMCMOption
             {
                 ...
                 AllowedValues = () => DropdownConfig.FestivalWinterSkirtOptions
            },
            // ====== 남자 자녀 (Boy) ======
            new GMCMOption
            {
            ...
            new GMCMOption {
                ...
                IsBoy = true,
                GetValue = s => ModEntry.Config.SpouseConfigs[s].BoyPantsColorOptions,
                SetValue = (s, v) => ModEntry.Config.SpouseConfigs[s].BoyPantsColorOptions = v,
