        ...
        public static readonly List<GMCMOption> GMCMOptions = new()
        {
            ...
            new GMCMOption
            {
             ...
             new GMCMOption
             {
                 ...
                 AllowedValues = s => DropdownConfig.ShoesColorOptions
             },
             new GMCMOption
             {
                 ...
                 AllowedValues = s => DropdownConfig.NeckCollarColorOptions
             },
             // 잠옷(타입/색상)
             new GMCMOption
             {
                 ...
                 AllowedValues = s => DropdownConfig.PajamaTypeOptions
             },
             new GMCMOption
             {
                 ...
                 AllowedValues = s =>
             {
                 var type = ModEntry.Config.SpouseConfigs[s].GirlPajamaTypesOptions ?? DropdownConfig.PajamaTypeOptions[0];
             ...
             new GMCMOption
             {
                 ...
                 AllowedValues = s => DropdownConfig.FestivalSummerSkirtOptions
             },
             new GMCMOption
             {
                 ...
                 AllowedValues = s => DropdownConfig.FestivalFallSkirts
             },
             new GMCMOption
             {
                 ...
                 AllowedValues = s => DropdownConfig.FestivalWinterSkirtOptions
            },
            // ====== 남자 자녀 (Boy) ======
            new GMCMOption
            {
            ...
            new GMCMOption {
                ...
                AllowedValues = s =>
            {
                var type = ModEntry.Config.SpouseConfigs[s].BoyPajamaTypeOptions ?? DropdownConfig.PajamaTypeOptions[0];
                return DropdownConfig.PajamaColorOptions[type];
            }
            },
            // 축제 바지
            ...
            AllowedValues = s => DropdownConfig.FestivalSummerPantsOptions
            },
            new GMCMOption {
                ...
                AllowedValues = s => DropdownConfig.FestivalFallPants
            },
            new GMCMOption {
                ...
                AllowedValues = s => DropdownConfig.FestivalWinterPantsOptions
            },
            // ====== 축제 공용(읽기 전용, 모든 자녀) ======
            new GMCMOption {
