        ...
        public static readonly List<GMCMOption> GMCMOptions = new()
        {
            ...
            new GMCMOption
            {
             ...
             new GMCMOption
             {
                 ...
                 AllowedValues = () =>
             {
                 var type = ModEntry.Config.SpouseConfigs[s].GirlPajamaTypesOptions ?? DropdownConfig.GirlPajamaTypeOptions[0];
            ...
            new GMCMOption {
                ...
                AllowedValues = () => DropdownConfig.BoyPantsColorOptions
            },
            new GMCMOption {
