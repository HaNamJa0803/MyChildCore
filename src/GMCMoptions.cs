        ...
        public static readonly List<GMCMOption> GMCMOptions = new()
        {
            ...
            new GMCMOption
            {
             ...
             new GMCMOption
             {
                 ...
                 IsBoy = false,
                 GetValue = s => ModEntry.Config.SpouseConfigs[s].GirlSkirtColors,
                 SetValue = (s, v) => ModEntry.Config.SpouseConfigs[s].GirlSkirtColors = v,
             ...
             new GMCMOption
             {
                 ...
                 IsBoy = false,
                 GetValue = s => ModEntry.Config.SpouseConfigs[s].GirlShoesColors,
                 SetValue = (s, v) => ModEntry.Config.SpouseConfigs[s].GirlShoesColors = v,
             ...
             new GMCMOption
             {
                 ...
                 IsBoy = false,
                 GetValue = s => ModEntry.Config.SpouseConfigs[s].GirlNeckCollarColors,
                 SetValue = (s, v) => ModEntry.Config.SpouseConfigs[s].GirlNeckCollarColors = v,
             ...
             new GMCMOption
             {
                 ...
                 AllowedValues = () =>
             {
                 var type = ModEntry.Config.SpouseConfigs[s].GirlPajamaTypes ?? DropdownConfig.PajamaTypeOptions[0];
            ...
            new GMCMOption {
                ...
                IsBoy = true,
                GetValue = s => ModEntry.Config.SpouseConfigs[s].BoyPantsColors,
                SetValue = (s, v) => ModEntry.Config.SpouseConfigs[s].BoyPantsColors = v,
            ...
            new GMCMOption {
                ...
                IsBoy = true,
                GetValue = s => ModEntry.Config.SpouseConfigs[s].BoyShoesColors,
                SetValue = (s, v) => ModEntry.Config.SpouseConfigs[s].BoyShoesColors = v,
                AllowedValues = () => DropdownConfig.ShoesColors
            },
            new GMCMOption {
                ...
                IsBoy = true,
                GetValue = s => ModEntry.Config.SpouseConfigs[s].BoyNeckCollarColors,
                SetValue = (s, v) => ModEntry.Config.SpouseConfigs[s].BoyNeckCollarColors = v,
                AllowedValues = () => DropdownConfig.NeckCollarColors
            },
            // 잠옷(타입/색상)
            new GMCMOption {
