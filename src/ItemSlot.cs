...
internal class ItemSlot : ItemWithBorder
{
	...
	public override void Draw(SpriteBatch b)
	{
		...
		if (base.BoxColor.HasValue)
		{
			...
			{
				IClickableMenu.drawTextureBox(b, (int)base.Position.X, (int)base.Position.Y, Width, Height, base.BoxColor.Value);
			}
		}
		if (Item != null)
		{
			Item.drawInMenu(b, base.Position + (Vector2)(base.BoxIsThin ? Vector2.Zero : new Vector2(16f, 16f)), 1f, 1f, 1f);
		}
