...
internal class ItemWithBorder : Element
{
	...
	public override int Width => 64 + ((!BoxIsThin) ? 16 : 0) * 2;

	public override int Height => 64 + ((!BoxIsThin) ? 16 : 0) * 2;
	...
	public override void Update(bool hidden = false)
	{
		...
		if (base.Hover && flag && SecondaryCallback != null)
		{
			SecondaryCallback(this);
		}
	}
	...
	public override void Draw(SpriteBatch b)
	{
		...
		if (BoxColor.HasValue)
		{
			if (BoxIsThin)
			{
				b.Draw(Game1.menuTexture, base.Position, (Rectangle?)Game1.getSourceRectForStandardTileSheet(Game1.menuTexture, 10, -1, -1), BoxColor.Value, 0f, Vector2.Zero, 1f, (SpriteEffects)0, 0.5f);
			}
			else
			{
				IClickableMenu.drawTextureBox(b, (int)base.Position.X, (int)base.Position.Y, Width, Height, BoxColor.Value);
			}
		}
		if (ItemDisplay != null)
		{
			ItemDisplay.drawInMenu(b, base.Position + (Vector2)(BoxIsThin ? Vector2.Zero : new Vector2(16f, 16f)), 1f, TransparentItemDisplay ? 0.5f : 1f, 1f);
		}
	}
}
