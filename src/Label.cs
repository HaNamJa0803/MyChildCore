...
internal class Label : Element
{
	...
	public Vector2 Measure()
	{
		...
		return MeasureString(String, Bold, Bold ? 1f : NonBoldScale, Font);
	}
	...
	public override void Draw(SpriteBatch b)
	{
		...
		bool flag = base.Hover && Callback != null;
		if (Bold)
		{
			SpriteText.drawString(b, String, (int)base.Position.X, (int)base.Position.Y, 999999, -1, 999999, 1f, 1f, false, -1, "", flag ? new Color?(SpriteText.color_Gray) : null, (ScrollTextAlignment)0);
			return;
		}
		Color val = (flag ? HoverTextColor : IdleTextColor);
		if (((Color)(ref val)).A > 0)
		{
			if (NonBoldShadow)
			{
				Utility.drawTextWithShadow(b, String, Font, base.Position, val, NonBoldScale, -1f, -1, -1, 1f, 3);
			}
			else
			{
				b.DrawString(Font, String, base.Position, val, 0f, Vector2.Zero, NonBoldScale, (SpriteEffects)0, 1f);
			}
		}
	}
