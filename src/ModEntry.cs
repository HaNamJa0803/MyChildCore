...
namespace MyChildCore
{
    ...
    public class ModEntry : Mod
    {
        ...
        public static IManifest ModManifest { get; private set; }
        ...
        public override void Entry(IModHelper helper)
        {
            ...
            ModManifest = this.ModManifest; // Manifest를 반드시 여기서!
            ...
            Log.Log("MyChildCore 모드(유니크 칠드런 최신) 로드 완료!", LogLevel.Info);
        }
        ...
        private void OnGameLaunched(object sender, GameLaunchedEventArgs e)
        {
            ...
            GMCMManager.RegisterGMCM(ModHelper, ModManifest);
        }
