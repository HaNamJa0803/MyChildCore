...
namespace MyChildCore
{
    public class SpouseChildConfig
    {
        ...
        public string GirlSkirtColorOptions { get; set; } = DropdownConfig.SkirtColorOptions[0];
        ...
        public string BoyPantsColorOptions { get; set; } = DropdownConfig.PantsColorOptions[0];
