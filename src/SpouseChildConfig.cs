...
namespace MyChildCore
{
    ...
    {
        // 아기 (공용)
        public string BabyHairStyle { get; set; } = DropdownConfig.BabyHairStyles[0];
        public string BabyEye { get; set; } = DropdownConfig.BabyEyes[0];
        public string BabySkin { get; set; } = DropdownConfig.BsbySkins[0];
        public string BabyBody { get; set; } = DropdownConfig.BabyBodies[0];

        // 여자 자녀
        public string GirlHairStyle { get; set; } = DropdownConfig.GirlHairStyles[0];
        public string GirlEye { get; set; } = DropdownConfig.GirlEyes[0];
        public string GirlSkin { get; set; } = DropdownConfig.GirlSkins[0];
