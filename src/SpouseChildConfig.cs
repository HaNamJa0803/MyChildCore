...
namespace MyChildCore
{
    public class SpouseChildConfig
    {
        ...
        public string FestivalSummerSkirtOptions { get; set; } = DropdownConfig.FestivalSummerSkirtOptions[0];
        public string FestivalWinterSkirtOptions { get; set; } = DropdownConfig.FestivalWinterSkirtOptions[0];
        public string FestivalFallSkirts { get; set; } = DropdownConfig.FestivalFallSkirts[0];
        ...
        public string FestivalSummerPantsOptions { get; set; } = DropdownConfig.FestivalSummerPantsOptions[0];
        public string FestivalWinterPantsOptions { get; set; } = DropdownConfig.FestivalWinterPantsOptions[0];
        public string FestivalFallPants { get; set; } = DropdownConfig.FestivalFallPants[0];
